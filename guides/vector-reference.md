...
Quick-lookup tables for vector coverpoint development. Use this when you need exact encodings, bit positions, or formulas. For coverpoint syntax and copy-paste patterns, see `generators/coverage/templates/GUIDE.md`.
