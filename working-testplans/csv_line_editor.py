...
def update_line(filepath: str, line_num: int, name: str = None, goal: str = None,
                desc: str = None, expect: str = None, bins: str = None, spec: str = None) -> None:
...
def main():
    ...
    if args.command == 'read':
        ...
        update_line(args.file, args.line, args.name, args.goal, args.desc,
                   args.expect, args.bins, args.spec)
