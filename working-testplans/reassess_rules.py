...
def has_data_edges(cps):
    ...
    data_edge_prefixes = [
        'cp_vs2_edges', 'cp_vs1_edges', 'cr_vs2_vs1_edges',
        'cp_rs1_edges', 'cr_vs2_rs1_edges', 'cp_fs1_edges', 'cr_vs2_fs1_edges',
        'cr_vs2_imm_edges', 'cr_vxrm_vs2_vs1_edges', 'cr_vxrm_vs2_rs1_edges',
        'cr_vxrm_vs2_imm_edges', 'cp_rs2_edges',
    ]
...
def main():
    ...
    for row in rows:
        ...
        status, explanation, gaps = assess_op_rule(
            row['rule_name'], row['spec_text'], cps
        )
