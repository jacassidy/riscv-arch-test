...
def instruction_to_op_rule(instr: str) -> str | None:
    ...
    SPECIAL = {
        # Widening add/sub
        'vwadd': 'vwadd_op', 'vwaddu': 'vwaddu_op',
        'vwsub': 'vwsub_op', 'vwsubu': 'vwsubu_op',
        # Narrowing shifts - map to the base shift op
        'vnsrl': 'vsrl_op', 'vnsra': 'vsra_op',
        # Narrowing clip
        'vnclip': None, 'vnclipu': None,
        # Extensions
        'vzext': None, 'vsext': None,
        # Reverse subtract
        'vrsub': 'vrsub_op',
        # FP instructions
        'vfadd': None, 'vfsub': None, 'vfmul': None, 'vfdiv': None,
        'vfrsub': None, 'vfrdiv': None,
        'vfwadd': None, 'vfwsub': None, 'vfwmul': None,
        'vfmacc': None, 'vfnmacc': None, 'vfmsac': None, 'vfnmsac': None,
        'vfmadd': None, 'vfnmadd': None, 'vfmsub': None, 'vfnmsub': None,
        'vfwmacc': None, 'vfwnmacc': None, 'vfwmsac': None, 'vfwnmsac': None,
        'vfmin': None, 'vfmax': None,
        'vfsgnj': None, 'vfsgnjn': None, 'vfsgnjx': None,
        'vfmerge': None, 'vfmv': None,
        'vfclass': None,
        'vfredosum': None, 'vfwredosum': None, 'vfredusum': None, 'vfwredusum': None,
        'vfredmax': None, 'vfredmin': None,
        'vfslide1up': None, 'vfslide1down': None,
        # Widening reductions
        'vwredsum': 'vredsum_op', 'vwredsumu': 'vredsum_op',
        # vmv instructions
        'vmv': 'vmv_op',
        # Whole register move
        'vmv1r': 'vmv-nr-r_op', 'vmv2r': 'vmv-nr-r_op',
        'vmv4r': 'vmv-nr-r_op', 'vmv8r': 'vmv-nr-r_op',
        # Gather
        'vrgather': None, 'vrgatherei16': None,
        # Merge
        'vmerge': None,
        # Saturating add/sub - no specific _op rule
        'vsadd': None, 'vsaddu': None, 'vssub': None, 'vssubu': None,
        # Averaging add/sub - no specific _op rule
        'vaadd': None, 'vaaddu': None, 'vasub': None, 'vasubu': None,
        # Saturating multiply
        'vsmul': None,
        # Scaling shifts
        'vssrl': None, 'vssra': None,
        # Convert instructions
        'vfcvt': 'vfcvt_op', 'vfwcvt': 'vfwcvt_op', 'vfncvt': None,
    }
...
INSTRUCTION_TO_OP = {
    # Integer arithmetic
    'vadd.vv': 'vadd_op', 'vadd.vx': 'vadd_op', 'vadd.vi': 'vadd_op',
    'vsub.vv': 'vsub_op', 'vsub.vx': 'vsub_op',
    'vrsub.vx': 'vrsub_op', 'vrsub.vi': 'vrsub_op',
    # Widening add/sub
    'vwadd.vv': 'vwadd_op', 'vwadd.vx': 'vwadd_op', 'vwadd.wv': 'vwadd_op', 'vwadd.wx': 'vwadd_op',
    'vwaddu.vv': 'vwaddu_op', 'vwaddu.vx': 'vwaddu_op', 'vwaddu.wv': 'vwaddu_op', 'vwaddu.wx': 'vwaddu_op',
    'vwsub.vv': 'vwsub_op', 'vwsub.vx': 'vwsub_op', 'vwsub.wv': 'vwsub_op', 'vwsub.wx': 'vwsub_op',
    'vwsubu.vv': 'vwsubu_op', 'vwsubu.vx': 'vwsubu_op', 'vwsubu.wv': 'vwsubu_op', 'vwsubu.wx': 'vwsubu_op',
    # Add/sub with carry
    'vadc.vvm': 'vadc_op', 'vadc.vxm': 'vadc_op', 'vadc.vim': 'vadc_op',
    'vsbc.vvm': 'vsbc_op', 'vsbc.vxm': 'vsbc_op',
    'vmadc.vvm': 'vmadc_op', 'vmadc.vxm': 'vmadc_op', 'vmadc.vim': 'vmadc_op',
    'vmadc.vv': 'vmadc_op', 'vmadc.vx': 'vmadc_op', 'vmadc.vi': 'vmadc_op',
    'vmsbc.vvm': 'vmsbc_op', 'vmsbc.vxm': 'vmsbc_op',
    'vmsbc.vv': 'vmsbc_op', 'vmsbc.vx': 'vmsbc_op',
    # Bitwise logical
    'vand.vv': 'vand_op', 'vand.vx': 'vand_op', 'vand.vi': 'vand_op',
    'vor.vv': 'vor_op', 'vor.vx': 'vor_op', 'vor.vi': 'vor_op',
    'vxor.vv': 'vxor_op', 'vxor.vx': 'vxor_op', 'vxor.vi': 'vxor_op',
    # Shifts
    'vsll.vv': 'vsll_op', 'vsll.vx': 'vsll_op', 'vsll.vi': 'vsll_op',
    'vsrl.vv': 'vsrl_op', 'vsrl.vx': 'vsrl_op', 'vsrl.vi': 'vsrl_op',
    'vsra.vv': 'vsra_op', 'vsra.vx': 'vsra_op', 'vsra.vi': 'vsra_op',
    'vnsrl.wv': 'vsrl_op', 'vnsrl.wx': 'vsrl_op', 'vnsrl.wi': 'vsrl_op',
    'vnsra.wv': 'vsra_op', 'vnsra.wx': 'vsra_op', 'vnsra.wi': 'vsra_op',
    # Compares
    'vmseq.vv': 'vmseq_op', 'vmseq.vx': 'vmseq_op', 'vmseq.vi': 'vmseq_op',
    'vmsne.vv': 'vmsne_op', 'vmsne.vx': 'vmsne_op', 'vmsne.vi': 'vmsne_op',
    'vmslt.vv': 'vmslt_op', 'vmslt.vx': 'vmslt_op',
    'vmsltu.vv': 'vmsltu_op', 'vmsltu.vx': 'vmsltu_op',
    'vmsle.vv': 'vmsle_op', 'vmsle.vx': 'vmsle_op', 'vmsle.vi': 'vmsle_op',
    'vmsleu.vv': 'vmsleu_op', 'vmsleu.vx': 'vmsleu_op', 'vmsleu.vi': 'vmsleu_op',
    'vmsgt.vx': 'vmsgt_op', 'vmsgt.vi': 'vmsgt_op',
    'vmsgtu.vx': 'vmsgtu_op', 'vmsgtu.vi': 'vmsgtu_op',
    # Min/max
    'vmin.vv': 'vmin_op', 'vmin.vx': 'vmin_op',
    'vminu.vv': 'vminu_op', 'vminu.vx': 'vminu_op',
    'vmax.vv': 'vmax_op', 'vmax.vx': 'vmax_op',
    'vmaxu.vv': 'vmaxu_op', 'vmaxu.vx': 'vmaxu_op',
    # Multiply
    'vmul.vv': 'vmul_op', 'vmul.vx': 'vmul_op',
    'vmulh.vv': 'vmulh_op', 'vmulh.vx': 'vmulh_op',
    'vmulhu.vv': 'vmulhu_op', 'vmulhu.vx': 'vmulhu_op',
    'vmulhsu.vv': 'vmulhsu_op', 'vmulhsu.vx': 'vmulhsu_op',
    # Widening multiply
    'vwmul.vv': 'vwmul_op', 'vwmul.vx': 'vwmul_op',
    'vwmulu.vv': 'vwmulu_op', 'vwmulu.vx': 'vwmulu_op',
    'vwmulsu.vv': 'vwmulsu_op', 'vwmulsu.vx': 'vwmulsu_op',
    # Divide/remainder
    'vdiv.vv': 'vdiv_op', 'vdiv.vx': 'vdiv_op',
    'vdivu.vv': 'vdivu_op', 'vdivu.vx': 'vdivu_op',
    'vrem.vv': 'vrem_op', 'vrem.vx': 'vrem_op',
    'vremu.vv': 'vremu_op', 'vremu.vx': 'vremu_op',
    # Multiply-add
    'vmacc.vv': 'vmacc_op', 'vmacc.vx': 'vmacc_op',
    'vnmsac.vv': 'vnmsac_op', 'vnmsac.vx': 'vnmsac_op',
    'vmadd.vv': 'vmadd_op', 'vmadd.vx': 'vmadd_op',
    'vnmsub.vv': 'vnmsub_op', 'vnmsub.vx': 'vnmsub_op',
    # Widening multiply-add
    'vwmacc.vv': 'vwmacc_op', 'vwmacc.vx': 'vwmacc_op',
    'vwmaccu.vv': 'vwmaccu_op', 'vwmaccu.vx': 'vwmaccu_op',
    'vwmaccsu.vv': 'vwmaccsu_op', 'vwmaccsu.vx': 'vwmaccsu_op',
    'vwmaccus.vx': 'vwmaccus_op',
    # Move
    'vmv.v.v': 'vmv_op', 'vmv.v.x': 'vmv_op', 'vmv.v.i': 'vmv_op',
    'vmv.x.s': 'vmv_op',
    'vmv.s.x': 'vmv-s-x_op',
    # Merge
    'vmerge.vvm': 'vmv_op', 'vmerge.vxm': 'vmv_op', 'vmerge.vim': 'vmv_op',
    # Mask logical
    'vmand.mm': 'vmand_op', 'vmnand.mm': 'vmnand_op', 'vmandn.mm': 'vmandn_op',
    'vmxor.mm': 'vmxor_op', 'vmor.mm': 'vmor_op', 'vmnor.mm': 'vmnor_op',
    'vmorn.mm': 'vmorn_op', 'vmxnor.mm': 'vmxnor_op',
    # Mask operations
    'vmsbf.m': 'vmsbf_op', 'vmsif.m': 'vmsif_op', 'vmsof.m': 'vmsof_op',
    'viota.m': 'viota_op',
    ...
    'vid.v': 'vid_op',
    # Whole register move
    'vmv1r.v': 'vmv-nr-r_op', 'vmv2r.v': 'vmv-nr-r_op',
    'vmv4r.v': 'vmv-nr-r_op', 'vmv8r.v': 'vmv-nr-r_op',
    # Reductions
    'vredsum.vs': 'vredsum_op', 'vredmaxu.vs': 'vredmaxu_op', 'vredmax.vs': 'vredmax_op',
    'vredminu.vs': 'vredminu_op', 'vredmin.vs': 'vredmin_op',
    'vredand.vs': 'vredand_op', 'vredor.vs': 'vredor_op', 'vredxor.vs': 'vredxor_op',
    'vwredsum.vs': 'vredsum_op', 'vwredsumu.vs': 'vredsum_op',
    # Slides
    'vslideup.vx': 'vslideup_op', 'vslideup.vi': 'vslideup_op',
    'vslidedown.vx': 'vslidedown_op', 'vslidedown.vi': 'vslidedown_op',
    'vslide1up.vx': 'vslide1up-vx_op', 'vslide1down.vx': 'vslide1down-vx_op',
    # Gather
    'vrgather.vv': None, 'vrgather.vx': None,
    ...
    'vmv4r.v': 'vmv-nr-r_op', 'vmv8r.v': 'vmv-nr-r_op',
    # FP compare
    'vmfeq.vv': 'vmfeq_op', 'vmfeq.vf': 'vmfeq_op',
    'vmfne.vv': 'vmfne_op', 'vmfne.vf': 'vmfne_op',
    'vmflt.vv': 'vmflt_op', 'vmflt.vf': 'vmflt_op',
    'vmfle.vv': 'vmfle_op', 'vmfle.vf': 'vmfle_op',
    'vmfgt.vf': 'vmfgt_op', 'vmfge.vf': 'vmfge_op',
    # FP convert
    'vfcvt.xu.f.v': 'vfcvt_op', 'vfcvt.x.f.v': 'vfcvt_op',
    'vfcvt.rtz.xu.f.v': 'vfcvt_op', 'vfcvt.rtz.x.f.v': 'vfcvt_op',
    'vfcvt.f.xu.v': 'vfcvt_op', 'vfcvt.f.x.v': 'vfcvt_op',
    'vfwcvt.xu.f.v': 'vfwcvt_op', 'vfwcvt.x.f.v': 'vfwcvt_op',
    'vfwcvt.rtz.xu.f.v': 'vfwcvt_op', 'vfwcvt.rtz.x.f.v': 'vfwcvt_op',
    'vfwcvt.f.xu.v': 'vfwcvt_op', 'vfwcvt.f.x.v': 'vfwcvt_op',
    ...
    'vle8.v': 'vector_ls_unit-stride_op', 'vle16.v': 'vector_ls_unit-stride_op',
    'vle32.v': 'vector_ls_unit-stride_op', 'vle64.v': 'vector_ls_unit-stride_op',
    'vse8.v': 'vector_ls_unit-stride_op', 'vse16.v': 'vector_ls_unit-stride_op',
    'vse32.v': 'vector_ls_unit-stride_op', 'vse64.v': 'vector_ls_unit-stride_op',
    # Fault-only-first
    'vle8ff.v': 'vector_ls_unit-stride_op', 'vle16ff.v': 'vector_ls_unit-stride_op',
    'vle32ff.v': 'vector_ls_unit-stride_op', 'vle64ff.v': 'vector_ls_unit-stride_op',
    # Load/store strided
    'vlse8.v': 'vector_ls_stride_ordered_op', 'vlse16.v': 'vector_ls_stride_ordered_op',
    'vlse32.v': 'vector_ls_stride_ordered_op', 'vlse64.v': 'vector_ls_stride_ordered_op',
    'vsse8.v': 'vector_ls_stride_ordered_op', 'vsse16.v': 'vector_ls_stride_ordered_op',
    'vsse32.v': 'vector_ls_stride_ordered_op', 'vsse64.v': 'vector_ls_stride_ordered_op',
    # Indexed unordered
    'vluxei8.v': 'vector_ls_stride_unordered_op', 'vluxei16.v': 'vector_ls_stride_unordered_op',
    'vluxei32.v': 'vector_ls_stride_unordered_op', 'vluxei64.v': 'vector_ls_stride_unordered_op',
    'vsuxei8.v': 'vector_ls_stride_unordered_op', 'vsuxei16.v': 'vector_ls_stride_unordered_op',
    'vsuxei32.v': 'vector_ls_stride_unordered_op', 'vsuxei64.v': 'vector_ls_stride_unordered_op',
    # Indexed ordered
    'vloxei8.v': 'vector_ls_stride_ordered_op', 'vloxei16.v': 'vector_ls_stride_ordered_op',
    'vloxei32.v': 'vector_ls_stride_ordered_op', 'vloxei64.v': 'vector_ls_stride_ordered_op',
    'vsoxei8.v': 'vector_ls_stride_ordered_op', 'vsoxei16.v': 'vector_ls_stride_ordered_op',
    'vsoxei32.v': 'vector_ls_stride_ordered_op', 'vsoxei64.v': 'vector_ls_stride_ordered_op',
}
...
def collect_edge_coverpoints():
    ...
    for csv_file in [
        ...
        with open(csv_file) as f:
            ...
            edge_cols = [c for c in reader.fieldnames
                        if 'edge' in c.lower() and c != 'cp_masking_edges']
...
def generate_coverage_desc(cp_name, instructions, rule_name):
    ...
    return (f"Edge coverpoint {cp_name} on [{instr_str}] tests {rule_name} by exercising "
